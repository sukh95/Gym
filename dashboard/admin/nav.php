...
<ul id="main-menu" class="" >
	...
	<li id="adminprofileb"><a href="viewcontactus.php"><i class="entypo-folder"></i><span>View Contact Us</span></a></li>
<li id="addrating"><a href="view_rating.php"><i class="entypo-gauge"></i><span>View Rating</span></a></li>
	...
	else
	{
		...
		<li id="dash"><a href="index.php"><i class="entypo-gauge"></i><span>Dashboard</span></a></li>
		<li class="" id="routinehassubopen"><a href="#" onclick="memberExpand(4)"><i class="entypo-alert"></i><span>Exercise Routine</span></a>
		<li id="health_status"><a href="my_new_health_status.php"><i class="entypo-user-add"></i><span>Health Status</span></a> 	
		<ul id="routineExpand">
			<li class="active">
				<a href="addroutine.php"><span>Add Routine</span></a>
			</li>
	...
	<li id="addrating"><a href="add_rating.php"><i class="entypo-gauge"></i><span>Add Rating</span></a></li>
	<li id="adminprofile"><a href="more-userprofile.php"><i class="entypo-folder"></i><span>Profile</span></a></li>

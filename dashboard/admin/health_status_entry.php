...
if(isset($_POST['submit']))
{
	...
	{
		$query="insert into health_status_records(calorie,height,weight,fat,remarks,uid) values('".$calorie."','".$height."','".$weight."','".$fat."','".$remarks."','".$userid."')";
		...
		{
			echo "<head><script>alert('Health Status Added ');</script></head></html>";
			echo "<meta http-equiv='refresh' content='0; url=my_new_health_status.php'>";
		}
...
<head>
   ...
   <title>The Gym | Health Status Entry</title>

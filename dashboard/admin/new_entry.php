       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
               ...
               <td height="35"><input name="u_pass" id="boxx" type="text"  required/></td>
             </tr>
             ...
             <tr>
               ...
               <td height="35"><input  name="street_name" maxlength="40" id="boxx"   required/></td>
             </tr>
             <tr>

...
if (isset($user_id_auth) && isset($pass) && isset($key)) {
    $sql    = "SELECT * FROM users WHERE userid='$user_id_auth' and securekey='$key'";
    $result = mysqli_query($con, $sql);
    $count  = mysqli_num_rows($result);
    if ($count == 1) {
        mysqli_query($con, "UPDATE users SET pass_key='$pass' WHERE userid='$user_id_auth'");
    ...
    echo "<meta http-equiv='refresh' content='0; url=forgot_f_password.php'>";
}
?>
<center>
<img src="loading.gif">
